...
const FormEditSiswa = () => {
  ...
  useEffect(() => {
    const init = async () => {
      try {
        const [dropdownRes, detailRes] = await Promise.all([
          api.get("/siswa/dropdown"),
          api.get(`/siswa/${id}`),
        ]);

        if (dropdownRes.data.status) {
          setKelasList(dropdownRes.data.data.kelas || []);
          setJurusanList(dropdownRes.data.data.jurusan || []);
          setTahunAjaranList(dropdownRes.data.data.tahun_ajaran || []);
        }
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="card shadow-sm border-0 mb-4">
          ...
          <div className="card-body row g-3">
            <div className="col-md-3">
              ...
              <input type="text" name="nis" className="form-control form-control-sm"
                value={formData.nis} onChange={handleChange} required />
            </div>
            <div className="col-md-3">
              <label className="form-label small fw-bold">NISN</label>
              <input type="text" name="nisn" className="form-control form-control-sm"
                value={formData.nisn} onChange={handleChange} />
            </div>
            <div className="col-md-6">
              <label className="form-label small fw-bold">Nama Lengkap</label>
              <input type="text" name="nama" className="form-control form-control-sm"
                value={formData.nama} onChange={handleChange} required />
            </div>
            <div className="col-md-3">
              <label className="form-label small fw-bold">Tempat Lahir</label>
              <input type="text" name="tempat_lahir" className="form-control form-control-sm"
            ...
            <div className="col-md-3">
              ...
              <select name="jenis_kelamin" className="form-select form-select-sm"
            ...
            <div className="col-md-3">
              ...
              <select name="agama" className="form-select form-select-sm"
                value={formData.agama} onChange={handleChange}>
        ...
        <div className="card shadow-sm border-0 mb-4">
          ...
          <div className="card-body row g-3">
            <div className="col-md-4">
              ...
              <select name="kelas" className="form-select form-select-sm"
            ...
            <div className="col-md-4">
              ...
              <select name="jurusan" className="form-select form-select-sm"
                value={formData.jurusan} onChange={handleChange}>
            ...
            <div className="col-md-4">
              ...
              <select name="tahun_ajaran" className="form-select form-select-sm"
                value={formData.tahun_ajaran} onChange={handleChange}>
                <option value="">Pilih Tahun Ajaran</option>
                {tahunAjaranList.map((item) => (
                  // Backend return key "nama" bukan "tahun_ajaran" di dropdown
                  <option key={item.id} value={item.nama}>{item.nama}</option>
                ))}
              </select>
            </div>
            ...
            <div className="col-md-4">
              ...
              <input type="text" name="sekolah_asal" className="form-control form-control-sm"
                value={formData.sekolah_asal} onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label className="form-label small fw-bold">Nomor HP Siswa</label>
              <input type="text" name="hp" className="form-control form-control-sm"
        ...
        <div className="card shadow-sm border-0 mb-4">
          ...
          <div className="card-body row g-3">
            <div className="col-md-4">
              ...
              <input type="text" name="ayah" className="form-control form-control-sm"
                value={formData.ayah} onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label className="form-label small fw-bold">Pekerjaan Ayah</label>
              <input type="text" name="pekerjaan_ayah" className="form-control form-control-sm"
                value={formData.pekerjaan_ayah} onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label className="form-label small fw-bold">HP Ayah</label>
              <input type="text" name="hp_ayah" className="form-control form-control-sm"
                value={formData.hp_ayah} onChange={handleChange} />
            </div>
            ...
            <div className="col-md-4">
              ...
              <input type="text" name="ibu" className="form-control form-control-sm"
                value={formData.ibu} onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label className="form-label small fw-bold">Pekerjaan Ibu</label>
              <input type="text" name="pekerjaan_ibu" className="form-control form-control-sm"
                value={formData.pekerjaan_ibu} onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label className="form-label small fw-bold">HP Ibu</label>
              <input type="text" name="hp_ibu" className="form-control form-control-sm"
                value={formData.hp_ibu} onChange={handleChange} />
            </div>
            ...
            <div className="col-md-4">
              ...
              <input type="text" name="wali" className="form-control form-control-sm"
                value={formData.wali} onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label className="form-label small fw-bold">Hubungan Wali</label>
              <input type="text" name="hubungan_wali" className="form-control form-control-sm"
                value={formData.hubungan_wali} onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label className="form-label small fw-bold">HP Wali</label>
              <input type="text" name="hp_wali" className="form-control form-control-sm"
                value={formData.hp_wali} onChange={handleChange} />
            </div>
          </div>
        </div>
        ...
        <div className="card shadow-sm border-0">
          <div className="card-body text-end">
            <button type="button" className="btn btn-light btn-sm me-2 fw-bold"
              onClick={() => navigate(-1)}>
              Batal
            </button>
            <button type="submit" className="btn btn-success btn-sm px-5 fw-bold">
              Simpan Perubahan
            </button>
          </div>
        </div>
