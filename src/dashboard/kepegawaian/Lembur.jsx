...
const Lembur = () => {
  ...
  const [dataLembur, setDataLembur] = useState([
    { id: 1, nama: 'Bayu Aji lesmana eka putra', unit: '0', mulai: '2025-10-06', selesai: '2025-10-09', alasan: 'Lembur Kejar Deadline', status: 'Rejected' },
    { id: 2, nama: 'Bayu Aji lesmana eka putra', unit: '0', mulai: '2025-10-06', selesai: '2025-10-06', alasan: 'Migrasi Database', status: 'Rejected' },
    { id: 3, nama: 'Agus Santoso', unit: '0', mulai: '2025-07-04', selesai: '2025-07-12', alasan: 'Maintenance Server', status: 'Rejected' },
    { id: 4, nama: 'Andi Susanto', unit: 'SD', mulai: '2025-07-04', selesai: '2025-07-11', alasan: 'Penyusunan Kurikulum', status: 'Rejected' },
    { id: 5, nama: 'Agus Santoso', unit: '0', mulai: '2025-07-04', selesai: '2025-07-11', alasan: 'Closing Akhir Bulan', status: 'Approved' },
  ]);
  ...
  const handleAjukanLembur = async () => {
    const { value: formValues } = await Swal.fire({
      title: `<div style="text-align: left; font-size: 18px; font-weight: 600; color: #1f2937; padding-bottom: 4px;">Ajukan Lembur</div>`,
      html: `
    ...
    if (formValues) {
      setDataLembur((prev) => [...prev, formValues]);

      Swal.fire({
        icon: "success",
        title: "Berhasil",
        text: "Pengajuan lembur berhasil ditambahkan",
        timer: 1500,
  ...
  const handleApprove = (id) => {
    ...
    Swal.fire({ icon: 'success', title: 'Approved', text: 'Lembur disetujui', timer: 1500, showConfirmButton: false });
  };
  ...
  const handleReject = (id) => {
    ...
    Swal.fire({ icon: 'error', title: 'Rejected', text: 'Lembur ditolak', timer: 1500, showConfirmButton: false });
  };
    ...
    <div className="p-6 bg-gray-100 min-h-screen font-sans">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-100 flex justify-between items-center">
          <h1 className="text-blue-600 font-semibold text-lg">Manajemen Lembur</h1>
          <button 
          ...
          >
            <Plus size={18} strokeWidth={3} /> Ajukan Lembur
          </button>
        </div>
                ...
                {filteredData.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={8} className="text-center py-8 text-gray-500">
                      Tidak ada data lembur yang cocok
                    </td>
                  </tr>
                )}
              </tbody>
