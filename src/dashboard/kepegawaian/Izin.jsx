...
const Izin = () => {
  const [dataIzin, setDataIzin] = useState([
    ...
    { id: 3, nama: 'Agus Santoso', unit: '0', mulai: '2025-07-04', selesai: '2025-07-12', alasan: 'Izin', status: 'Rejected' },
  ...
  const handleAjukanIzin = () => {
    Swal.fire({
      title: 'Ajukan Izin',
      text: 'Formulir pengajuan Izin akan muncul di sini.',
      icon: 'info',
